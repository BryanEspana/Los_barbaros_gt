...
const media = [
  { src: "/images/hero.jpeg", alt: "Los Bárbaros en concierto", span: "col-span-2 md:row-span-2", type: "image" },
  { src: "/images/gallery-2.jpeg", alt: "Público disfrutando", span: "col-span-1", type: "image" },
  { src: "/images/gallery-3.jpeg", alt: "Baterista en vivo", span: "col-span-1", type: "image" },
  { src: "/images/gallery-5.mp4", alt: "Energía pura", span: "col-span-2", type: "video" },
  { src: "/images/gallery-8.mp4", alt: "Ambiente increíble", span: "col-span-2", type: "video" },
  { src: "/images/gallery-4.jpeg", alt: "Evento corporativo", span: "col-span-1", type: "image" },
  { src: "/images/gallery-9.mp4", alt: "La mejor música", span: "col-span-1", type: "video" },
  { src: "/images/about.jpeg", alt: "Banda en evento", span: "col-span-2", type: "image" },
  { src: "/images/gallery-6.mp4", alt: "Show en vivo", span: "col-span-2", type: "video" },
];
            ...
            >
              {selectedItem.type === "image" ? (
                ...
                <video
                  ...
                  controls
                  autoPlay
                  className="rounded-lg max-h-[90vh] max-w-full shadow-2xl"
                />
              )}
